...
install_grub()
{
    ...
    if [ "$K3OS_ENCRYPT_FILESYSTEM" = "true" ]; then
        ...
        ROOT_PART_UUID_NO_DASHES=$(echo $ROOT_PART_UUID | sed -e "s/-//" -e "s///")
...
#
# It is NOT automatically generated by grub-mkconfig using templates
# but instead written by hand for use with K3OS.
#
...
stop_script()
{
    echo "Install script was forcefully stopped."
    exit 1
}
